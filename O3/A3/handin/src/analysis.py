...
def get_nis(meas_pred: MultiVarGauss, meas: Measurement2d) -> float:
    ...
    nis = meas_pred.mahalanobis_distance(meas.value)
...
def get_nees(state_est: MultiVarGauss, x_gt: np.ndarray):
    ...
    Tip: use the mahalanobis_distance method of state_est, (3.2) in the book
    """

    # TODO replace this with own code
    NEES = state_est.mahalanobis_distance(x_gt)
    return NEES
